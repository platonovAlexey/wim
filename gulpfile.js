...
gulp.task('map-style:build', function () {
...
gulp.task('watch', function(){
    ...
    // watch([path.watch.mapStyle], function(event, cb) {
    //     gulp.start('map-style:build');
    // });
    watch(path.src.mapStyle, ['map-style']);
